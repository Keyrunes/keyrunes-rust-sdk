...
async fn test_register_success() {
    ...
    let mock = server
        ...
        .with_status(201)
        .with_header("content-type", "application/json")
        .with_body(r#"{"user_id":42,"external_id":"0b3f6d5a-7c1e-4f2a-9d3b-1a2b3c4d5e6f","id":"8a9b0c1d-2e3f-4a5b-8c6d-7e8f9a0b1c2d","username":"john","email":"john@example.com","groups":[],"first_login":true,"organization_id":1,"namespace":"public"}"#)
        .create_async()
        .await;
...
async fn test_register_and_login_flow() {
    ...
    let register_mock = server
        ...
        .with_status(201)
        .with_header("content-type", "application/json")
        .with_body(r#"{"user_id":123,"external_id":"0b3f6d5a-7c1e-4f2a-9d3b-1a2b3c4d5e6f","id":"8a9b0c1d-2e3f-4a5b-8c6d-7e8f9a0b1c2d","username":"john","email":"john@example.com","groups":[],"first_login":true,"organization_id":1,"namespace":"public"}"#)
        .create_async()
        .await;
...
async fn test_register_admin_success() {
    ...
    let mock = server
        ...
        .with_header("content-type", "application/json")
        .with_body(
            r#"{"user_id":999,"external_id":"0b3f6d5a-7c1e-4f2a-9d3b-1a2b3c4d5e6f","id":"8a9b0c1d-2e3f-4a5b-8c6d-7e8f9a0b1c2d","username":"admin","email":"admin@example.com","groups":["admins"],"first_login":true,"organization_id":1,"namespace":"public"}"#,
        )
        .create_async()
        .await;
...
async fn test_register_response_parsing() {
    ...
    let mock = server
        ...
        .with_status(201)
        .with_header("content-type", "application/json")
        .with_body(r#"{"user_id":456,"external_id":"0b3f6d5a-7c1e-4f2a-9d3b-1a2b3c4d5e6f","id":"8a9b0c1d-2e3f-4a5b-8c6d-7e8f9a0b1c2d","username":"parseduser","email":"parsed@example.com","groups":["users","testers"],"first_login":true,"organization_id":1,"namespace":"public"}"#)
        .create_async()
        .await;
...
async fn test_register_admin_response_parsing() {
    ...
    let mock = server
        ...
        .with_status(201)
        .with_header("content-type", "application/json")
        .with_body(r#"{"user_id":789,"external_id":"0b3f6d5a-7c1e-4f2a-9d3b-1a2b3c4d5e6f","id":"8a9b0c1d-2e3f-4a5b-8c6d-7e8f9a0b1c2d","username":"adminparsed","email":"adminparsed@example.com","groups":["admins","superusers"],"first_login":true,"organization_id":1,"namespace":"public"}"#)
        .create_async()
        .await;
